...
const navItems: NavItem[] = [
  ...
  { to: ROUTES.ADMIN.TECNICOS, icon: Wrench, label: "Técnicos" },
  { to: ROUTES.ADMIN.CLIENTES, icon: Users, label: "Clientes" },
  { to: ROUTES.ADMIN.SERVICIOS, icon: ShoppingBag, label: "Servicios" },
  { to: ROUTES.ADMIN.CATEGORIAS, icon: Tag, label: "Categorías" },
  { to: ROUTES.ADMIN.INGRESOS, icon: DollarSign, label: "Ingresos" },
