...
import type { Categoria, TecnicoConScore, FiltrosTecnicos } from '../types'
...
export function useTecnicos(filtros: FiltrosTecnicos = {}) {
  const [tecnicos, setTecnicos]   = useState<TecnicoConScore[]>([])
  ...
  const fetchTecnicos = useCallback(async () => {
    ...
    let resultado = (data as unknown as TecnicoConScore[]) || []
    ...
    resultado.sort((a, b) => (b.scoreRecomendacion || 0) - (a.scoreRecomendacion || 0))
