...
export default function TarjetaSolicitud({
    ...
    const handleAccion = async (estado, extras) => {
        setProcesando(true)
    ...
    const handleConfirmar = async () => {
        if (!precio || isNaN(precio)) { alert('Ingresa el monto final'); return }
        setProcesando(true)
    ...
    const yaCalificado = solicitud.resenas?.length > 0
                ...
                <div className="fixed inset-0 bg-black/40 z-50 flex items-end sm:items-center justify-center p-4">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6">
                        ...
                        <p className="text-sm text-gray-500 mb-5">
                            Al confirmar, el pago se liberará al técnico (90%) y ChambaYA cobrará la comisión del 10%.
                        </p>
                        ...
                        {precio && !isNaN(precio) && Number(precio) > 0 && (
                            <div className="bg-gray-50 rounded-xl p-4 mb-5 space-y-2 text-sm">
                                ...
                                <div className="flex justify-between text-red-500">
                                    <span>Comisión ChambaYA (10%)</span>
            ...
            {modalResena && (
                <div className="fixed inset-0 bg-black/40 z-50 flex items-end sm:items-center justify-center p-4">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6">
                        ...
                        <p className="text-sm text-gray-500 mb-5">
                            Tu reseña ayuda a otros clientes y mejora el ranking del técnico.
                        </p>
