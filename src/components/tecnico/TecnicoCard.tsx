...
export default function TecnicoCard({ tecnico, destacado = false }: TecnicoCardProps) {
        ...
        >
            ...
            {es_premium && (
                <div className="bg-gradient-to-r from-amber-400 to-orange-400 px-4 py-1.5 flex items-center gap-1.5">
                    ...
                    <span className="text-xs font-semibold text-white tracking-wide">TECNICO PREMIUM</span>
                </div>
            )}
