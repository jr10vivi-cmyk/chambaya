import { Star, MapPin, Crown, ChevronRight, Zap } from "lucide-react";
...
export default function TecnicoCard({
  ...
  return (
    <Link
      ...
      className={`block bg-white rounded-2xl border transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5
        ${
          destacado
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-start gap-4 mb-3">
          {/* Avatar */}
          <div
            className={`relative w-14 h-14 rounded-2xl flex items-center justify-center text-xl font-bold flex-shrink-0
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1 mt-0.5">
              ...
              <span className="text-xs text-gray-400 truncate">
                {profiles?.ciudad || "Ubicacion no definida"}
              ...
              <div className="flex">
                {[1, 2, 3, 4, 5].map((n) => (
                  <Star
                    ...
                    size={12}
                    className={
                      n <= Math.round(calificacion_promedio || 0)
                        ? "text-amber-400"
                        : "text-gray-200"
                    }
                    fill="currentColor"
