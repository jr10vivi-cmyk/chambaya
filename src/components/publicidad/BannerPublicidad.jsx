 ...
 *
 * Props:
 *   posicion  - donde se muestra ('inicio' | 'buscar' | 'lateral')
 *   tipo      - filtro de tipo ('banner' | 'destacado' | 'popup' | undefined = todos)
 *   className - clases adicionales para el contenedor
 */
export default function BannerPublicidad({ posicion = 'inicio', tipo, className = '' }) {
  ...
  return (
    <div className={`relative overflow-hidden rounded-2xl ${className}`}>
      ...
      >
        ...
        {/* Boton cerrar */}
        <button
          onClick={e => { e.stopPropagation(); setCerrados(s => new Set([...s, anuncio.id])) }}
