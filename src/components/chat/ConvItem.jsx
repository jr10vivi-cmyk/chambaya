...
export default function ConvItem({ conv, activa, onClick, miRole }) {
    ...
    }[conv.solicitudes?.estado] || 'bg-gray-300'
    ...
    return (
        ...
        >
            ...
            <div className="relative flex-shrink-0">
                ...
                <div className={`absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 ${estadoColor} rounded-full border-2 border-white`} />
            </div>
