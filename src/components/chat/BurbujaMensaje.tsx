...
import type { Mensaje, Profile } from '../../types'

interface MensajeConProfile extends Mensaje {
...
interface BurbujaMensajeProps {
    mensaje: MensajeConProfile
    esMio: boolean
}

export default function BurbujaMensaje({ mensaje, esMio }: BurbujaMensajeProps) {
