...
export default function VentanaChat({ conversacionId, onVolver }: VentanaChatProps) {
    ...
    if (!conv) return (
        <div className="flex items-center justify-center h-full text-gray-400">
            <div className="text-center">
                ...
                <p className="font-medium">Conversacion no encontrada</p>
            </div>
        </div>
    )
    ...
    const gruposPorFecha = mensajes.reduce<Record<string, typeof mensajes>>((acc, msg) => {
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 bg-gray-50">
                ...
                {mensajes.length === 0 && (
                    <div className="flex flex-col items-center justify-center h-full text-center">
                        ...
                        <p className="font-semibold text-gray-700 mb-1">Inicia la conversacion!</p>
                        <p className="text-sm text-gray-400 max-w-xs">
                            Cuentale al {esCliente ? 'tecnico' : 'cliente'} los detalles del trabajo que necesitas.
                        </p>
