...
import {
  Wrench, Search, Star, Shield, Zap, MapPin,
  MessageCircle, CheckCircle, Crown, ChevronRight,
  Hammer, Droplets, Flame, Monitor, Wind, Key,
  ArrowRight, Menu, X
} from 'lucide-react'
...
const CATEGORIAS = [
  ...
  { icon: Monitor, nombre: 'Técnico PC', color: 'from-purple-400 to-violet-500' },
  { icon: Wind, nombre: 'Aire Acond.', color: 'from-teal-400 to-cyan-500' },
  { icon: Key, nombre: 'Cerrajero', color: 'from-slate-400 to-gray-600' },
  { icon: Wrench, nombre: 'Más oficios...', color: 'from-gray-400 to-slate-500' },
]
...
const TESTIMONIOS = [
  {
    nombre: 'Rosa Flores',
    ciudad: 'Ayacucho',
    texto: 'Encontré un electricista en 10 minutos. El trabajo quedó perfecto y el pago fue seguro. ¡Increíble plataforma!',
    estrellas: 5,
    inicial: 'R',
  ...
  },
  {
    ...
    ciudad: 'Huanta',
    texto: 'Como técnico, ChambaYA me consiguió 3 trabajos en la primera semana. El sistema de pagos es transparente.',
    estrellas: 5,
    inicial: 'C',
  ...
  },
  {
    nombre: 'Ana Quispe',
    ciudad: 'Ayacucho',
    texto: 'El mapa para encontrar técnicos cercanos es genial. Encontré uno a 2 km de mi casa con 4.9 estrellas.',
    estrellas: 5,
    inicial: 'A',
    ...
    <nav style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {['#como-funciona:Cómo funciona', '#categorias:Categorías', '#tecnicos:Para técnicos'].map(item => {
...
function Hero() {
  return (
    <section style={{
      minHeight: '100vh',
      display: 'flex', alignItems: 'center',
      paddingTop: '64px', overflow: 'hidden', position: 'relative',
      background: 'linear-gradient(135deg, #fffbf5 0%, #ffffff 50%, #fffbeb 100%)',
    }}>
      {/* Fondo decorativo */}
      <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <h1 style={{
            ...
            <span style={{ color: '#f97316', position: 'relative' }}>
              de confianza
              <svg style={{ position: 'absolute', bottom: '-6px', left: 0, width: '100%' }}
                viewBox="0 0 300 10" fill="none">
                <path d="M2 7 Q75 2 150 6 Q225 10 298 4"
          ...
          <p style={{
            ...
            Conectamos clientes con técnicos verificados.
            Electricistas, plomeros, carpinteros y más — rápido, seguro y transparente.
          </p>
          ...
          <div style={{
            ...
            border: '1px solid #fed7aa', maxWidth: '440px', marginBottom: '28px',
          }}>
            <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '2px', marginBottom: '2px' }}>
                ...
                <span style={{ fontSize: '12px', fontWeight: 700, color: '#111', marginLeft: '4px' }}>4.8</span>
              </div>
              <p style={{ fontSize: '11px', color: '#888' }}>+2,800 servicios completados</p>
            </div>
          </div>
        </div>
        ...
        <div style={{ position: 'relative' }}>
          <div style={{
            ...
            border: '1px solid #fed7aa', position: 'relative', zIndex: 1,
          }}>
            {/* Header */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <p style={{ fontWeight: 700, fontSize: '14px', color: '#111', marginBottom: '3px' }}>Juan Ríos Flores</p>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                    <div style={{ width: '7px', height: '7px', borderRadius: '50%', background: '#4ade80' }} />
                    <span style={{ fontSize: '11px', color: '#888' }}>Disponible ahora</span>
                  </div>
                </div>
              </div>
              <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '8px', marginBottom: '16px' }}>
              {[
                ...
                <div key={lbl} style={{
                  ...
                  <p style={{ fontSize: '15px', fontWeight: 800, color: '#111', lineHeight: 1 }}>{val}</p>
                  <p style={{ fontSize: '9px', color: '#888', marginTop: '2px' }}>{lbl}</p>
                </div>
              ))}
            </div>
          ...
          {/* Badges flotantes */}
          {[
            { text: '📍 1.2 km de ti', style: { top: '-14px', right: '-14px' } },
            { text: '💬 Chat protegido', style: { bottom: '-14px', left: '-14px' } },
          ].map(({ text, style }) => (
            <div key={text} style={{
              position: 'absolute', background: 'white',
              borderRadius: '12px', padding: '8px 13px',
              display: 'flex', alignItems: 'center', gap: '6px',
              fontSize: '11px', fontWeight: 700, color: '#111',
              boxShadow: '0 4px 16px rgba(0,0,0,0.1)',
              border: '1px solid #f1f0eb', zIndex: 2,
              ...style,
            }}>
              {text}
            </div>
    ...
    <section id="categorias" ref={ref} className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          <p className="text-orange-500 font-bold text-sm uppercase tracking-widest mb-3">Oficios disponibles</p>
    ...
    <section id="como-funciona" ref={ref} className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          <p className="text-orange-500 font-bold text-sm uppercase tracking-widest mb-3">Proceso simple</p>
          <h2 className="text-4xl font-black text-gray-900" style={{ fontFamily: "'Syne', sans-serif" }}>
            Funciona en 4 pasos
          </h2>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {PASOS.map(({ num, titulo, desc, color, numColor }, i) => (
            ...
            >
              ...
              <p className={`text-5xl font-black mb-4 ${numColor}`}
                style={{ fontFamily: "'Syne', sans-serif" }}>
                {num}
              </p>
...
function Garantias() {
  const [ref, visible] = useInView()
  const items = [
    { icon: Shield, titulo: 'Técnicos verificados', desc: 'Cada técnico pasa por un proceso de verificación antes de aparecer en la plataforma.', color: 'text-blue-500 bg-blue-50' },
    { icon: CheckCircle, titulo: 'Pago 100% seguro', desc: 'Tu dinero se libera al técnico solo cuando confirmas que el trabajo está bien hecho.', color: 'text-green-500 bg-green-50' },
    { icon: MessageCircle, titulo: 'Chat protegido', desc: 'Comunícate sin compartir datos personales. Bloqueamos automáticamente intentos de fuga.', color: 'text-purple-500 bg-purple-50' },
    { icon: Star, titulo: 'Sistema de reputación', desc: 'Calificaciones reales de clientes reales. Elige siempre al mejor para tu trabajo.', color: 'text-amber-500 bg-amber-50' },
  ]
  return (
    <section ref={ref} className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          <p className="text-orange-500 font-bold text-sm uppercase tracking-widest mb-3">Por qué elegirnos</p>
          <h2 className="text-4xl font-black text-gray-900" style={{ fontFamily: "'Syne', sans-serif" }}>
    ...
    <section ref={ref} className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {TESTIMONIOS.map(({ nombre, ciudad, texto, estrellas, inicial, color }, i) => (
            <div key={nombre}
            ...
            >
              ...
              <div className="flex mb-4">
                {Array.from({ length: estrellas }).map((_, n) => (
                  <Star key={n} size={16} className="text-amber-400" fill="currentColor" />
                ))}
              </div>
              <p className="text-gray-700 text-sm leading-relaxed mb-5">"{texto}"</p>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-4xl font-black text-white mb-6" style={{ fontFamily: "'Syne', sans-serif" }}>
              Genera más ingresos<br />con tu oficio
            </h2>
            <p className="text-gray-400 text-lg leading-relaxed mb-8">
              Regístrate, completa tu perfil y empieza a recibir solicitudes de trabajo hoy mismo. Sin complicaciones, sin inversión inicial.
            </p>
          ...
          >
            {[
              { icon: '💰', titulo: 'Gana más', desc: 'Recibe hasta 3× más trabajo con perfil Premium', bg: 'bg-orange-500/10 border-orange-500/20' },
              { icon: '📍', titulo: 'Zona cercana', desc: 'Solo trabajos en tu radio de acción preferido', bg: 'bg-blue-500/10 border-blue-500/20' },
              { icon: '💬', titulo: 'Chat directo', desc: 'Coordina con clientes sin dar tu número personal', bg: 'bg-purple-500/10 border-purple-500/20' },
              { icon: '⭐', titulo: 'Reputación', desc: 'Construye un perfil sólido con reseñas reales', bg: 'bg-amber-500/10 border-amber-500/20' },
    ...
    <section className="py-20 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-3xl p-12 border border-orange-100 shadow-xl shadow-orange-50">
          ...
          <h2 className="text-4xl font-black text-gray-900 mb-4" style={{ fontFamily: "'Syne', sans-serif" }}>
            ¿Listo para empezar?
          </h2>
          <p className="text-gray-600 mb-8 text-lg">
            Únete a miles de peruanos que ya usan ChambaYA para encontrar técnicos confiables.
          </p>
    ...
    <footer className="bg-gray-900 text-gray-400 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed">
              La plataforma que conecta clientes con técnicos verificados en todo el Perú.
            </p>
          </div>

          {/* Links */}
          {[
            { titulo: 'Plataforma', links: ['Cómo funciona', 'Categorías', 'Para técnicos', 'Precios Premium'] },
            { titulo: 'Empresa', links: ['Sobre nosotros', 'Blog', 'Trabaja con nosotros', 'Prensa'] },
            { titulo: 'Legal', links: ['Términos de uso', 'Privacidad', 'Cookies', 'Contacto'] },
          ].map(({ titulo, links }) => (
            <div key={titulo}>
              ...
              <ul className="space-y-2">
                {links.map(l => (
                  <li key={l}>
                    <a href="#" className="text-sm hover:text-orange-400 transition">{l}</a>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs">© 2026 ChambaYA. Todos los derechos reservados.</p>
          <div className="flex items-center gap-2 text-xs">
            <Shield size={12} className="text-green-400" />
            <span>Plataforma segura · Pagos protegidos · Técnicos verificados</span>
          </div>
        </div>
      </div>
    </footer>
