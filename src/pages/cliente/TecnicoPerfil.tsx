              ...
              <div className="flex items-center gap-5 mt-4 flex-wrap">
                ...
                {tecnico.experiencia_anos > 0 && (
                  <div className="flex items-center gap-1 text-sm text-gray-500">
                    ...
                    <span>
                      año{tecnico.experiencia_anos > 1 ? "s" : ""} exp.
                    </span>
                  </div>
                )}
              </div>
          ...
          <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              <h3 className="font-semibold text-gray-900">
                Solicitar servicio a {tecnico.profiles?.nombre}
              </h3>
              <button
            ...
            <form onSubmit={handleSolicitar} className="p-5 space-y-4">
              {[
                {
                  key: "titulo",
                  label: "¿Qué necesitas?",
                  placeholder: "Ej: Reparar enchufe de cocina",
                  required: true,
                },
                {
                  key: "descripcion",
                ...
                <div key={key}>
                  ...
                  {textarea ? (
                    <textarea
                      ...
                      value={solicitud[key]}
                      onChange={(e) =>
                        setSolicitud((p) => ({ ...p, [key]: e.target.value }))
                      }
              ...
              <div className="bg-amber-50 border border-amber-100 rounded-xl p-3">
                <p className="text-xs text-amber-700 flex items-start gap-1.5">
                  ...
                  El pago se realiza dentro de la plataforma. El técnico
                  recibirá el 90% al completar el trabajo.
                </p>
              </div>
