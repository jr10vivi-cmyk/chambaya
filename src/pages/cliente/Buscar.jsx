...
import {
  Search, MapPin, Sliders, Star, ChevronDown,
  List, Map, Loader2, X, LocateFixed
} from 'lucide-react'
  ...
  return (
    <div className="flex flex-col h-full -m-4 md:-m-8">
      ...
      <div className="bg-white border-b border-gray-100 px-4 md:px-6 py-3 z-10 flex-shrink-0">
        ...
        <div className="flex gap-2 mb-2">
          ...
          <button
            ...
            <span className="hidden sm:inline">{userPos ? 'Ubicado' : 'Mi ubicación'}</span>
          </button>
          ...
          <div className="mt-3 pt-3 border-t border-gray-100 grid grid-cols-2 sm:grid-cols-3 gap-3">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-500 mb-1.5">
                <MapPin size={11} className="inline mr-1" />Radio de búsqueda
              </label>
            ...
            <div>
              <label className="block text-xs font-medium text-gray-500 mb-1.5">
                <Star size={11} className="inline mr-1" />Calificación mínima
              </label>
              <div className="flex gap-1 flex-wrap">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Lista de técnicos */}
        <div className={`flex-shrink-0 overflow-y-auto bg-gray-50
        ...
        >
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center px-6">
              ...
              <p className="font-semibold text-gray-700 mb-1">Sin técnicos disponibles</p>
              <p className="text-sm text-gray-400">Prueba cambiando los filtros o amplía el radio de búsqueda</p>
              <button onClick={() => { setCategoriaId(''); setBusqueda(''); setBusquedaInput(''); setRadioKm(null) }}
